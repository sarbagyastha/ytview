...
#import "YTWKNavigationDelegate.h"
#import "JavaScriptChannelHandler.h"

@implementation YTWebViewFactory {
...
- (NSObject<FlutterPlatformView>*)createWithFrame:(CGRect)frame
  ...
  YTWebViewController* webviewController = [[YTWebViewController alloc] initWithFrame:frame
...
@implementation YTWebViewController {
  ...
  YTWKNavigationDelegate* _navigationDelegate;
}
...
- (instancetype)initWithFrame:(CGRect)frame
  ...
  if (self = [super init]) {
    ...
    _navigationDelegate = [[YTWKNavigationDelegate alloc] initWithChannel:_channel];
...
- (void)registerJavaScriptChannels:(NSSet*)channelNames
  ...
  for (NSString* channelName in channelNames) {
    YTJavaScriptChannel* channel =
        [[YTJavaScriptChannel alloc] initWithMethodChannel:_channel
